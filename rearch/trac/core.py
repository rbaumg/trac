...
def populate_hdf(hdf, env, req=None):
    # This function shouldn't be used anymore. The corresponding items are added
    # to the template data by the chrome plugin (and by the compat plugin for 
    # stuff that is going to be done different).
    pass
